...
A **contingency table** lists the frequency of each combination of values of two categorical variables. For example, a survey of 2,237 people recording gender and handedness might produce the following table.
...
![Waiting time and eruption duration of Old Faithful](figs/ch4/scatter_1.png){width="70%"}
...
![Section A students](figs/ch4/scatter-a.png){width="45%"} ![Section B students](figs/ch4/scatter-b.png){width="45%"}
...
![Positive correlation](figs/ch4/positive-r.png){width="100%"} 

![Negative correlation](figs/ch4/negative-r.png){width="100%"}
...
**(a)**
<div class="exercise-table" style="width:70%; margin:auto; font-size:0.85em;">
...
Moreover, the correlation coefficient is *not** affected by any of the three changes:
- 1) interchanging the two variables, 
- 2) adding the same number to all the values of one variable, and 
