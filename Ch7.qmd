...
**Try these:**
**(1)** A fair coin is tossed twice. What is the chance of getting a head then a tail?
**(2)**  A die is rolled three times. (i) Find the chance that the first roll is an ACE. (ii) Find the chance that the first roll is an ACE, the second roll is a deuce, and the third roll is a trey..
...
**Likelihood (Witness Accuracy):** This quantifies how probable the observed evidence (witness testimony) is under different hypotheses. The witness correctly identifies blue taxis 80% of the time and incorrectly identifies black taxis as blue 20% of the time. This creates two competing likelihoods:
- If the taxi was actually blue, we'd expect her to say "blue" 80% of the time
- If the taxi was actually black, we'd expect her to mistakenly say "blue" 20% of the time
