...
Many introductory statistics textbooks also discuss **measures of relative standing**, such as **percentiles** and **quartiles**, as well as graphical summaries like the **box plot**, shown below.[^ch3-3]

[^ch3-3]: Additional examples are provided in standard textbooks and in the PowerPoint slides accompanying this book.

![A box-plot example](figs/ch3/boxplot.png){fig-align="center" width="60%"}
...
15. Find a real dataset (for example, income, test scores, or prices):
