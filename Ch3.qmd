...
This, however, is just a mathematical operation. The **standard deviation** is defined more specifically as the root mean square of the **deviations from the mean**, that is,
...
7.  Why does the variance have squared units, and why can this make interpretation difficult?
...
8.  Explain the difference between the population standard deviation and the sample standard deviation.

9.  Why do we divide by $(n - 1)$ rather than $n$ when computing the sample standard deviation?

10. In what situations would it be appropriate to treat your data as a sample rather than a population?

### Measures of relative standing

11. Explain what it means for a value to be at the 75th percentile of a distribution.

12. Why is the median equal to the 50th percentile?

13. Describe how a box plot summarizes information about central location, dispersion, and relative standing.
...
b.  Compute the standard deviation, SD.\
